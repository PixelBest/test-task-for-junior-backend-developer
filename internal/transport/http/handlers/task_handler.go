...
func (h *TaskHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	created, err := h.usecase.Create(r.Context(), taskusecase.CreateInput{
		...
		PeriodicityDates: req.PeriodicityDates,
	})
	if err != nil {
...
func (h *TaskHandler) SetInProgress(w http.ResponseWriter, r *http.Request) {
	...
	task, err := h.usecase.SetInProgress(r.Context(), id)
	if err != nil {
		writeUsecaseError(w, err)
		return
	}
...
func (h *TaskHandler) SetDone(w http.ResponseWriter, r *http.Request) {
	...
	task, err := h.usecase.SetDone(r.Context(), id)
	if err != nil {
		writeUsecaseError(w, err)
		return
	}
...
func (h *TaskHandler) ClosePeriodicTask(w http.ResponseWriter, r *http.Request) {
	id, err := getIDFromRequest(r)
	if err != nil {
		writeError(w, http.StatusBadRequest, err)
		return
	...
	if err := h.usecase.ClosePeriodicTask(r.Context(), id); err != nil {
		writeUsecaseError(w, err)
		return
	}
